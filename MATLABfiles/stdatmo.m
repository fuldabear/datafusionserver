function [rho,a,T,P]=stdatmo(H_in,Toffset,Units,GeomFlag)
...
% 
%   Example 1: Create tables of atmospheric properties up to 30000ft for a
...
%       [junk,h,dT]=meshgrid(0,-5000:1000:30000,-15:15:15);
...
%       HotTable        = Table(:,:,3)
%
%   Example 2: Find the SI dynamic pressure, Mach number, Reynolds number,
...
%   86km geometric altitude (84852m geopotential) and returns NaN for
%   altitudes above 90km geopotential.
%
